...
<body >
	...
	<div class="container-scroller">
		...
		<nav
			...
			<div
				...
				<a class="navbar-brand brand-logo" href="home/client.htm"><img
					...
					<li class="nav-item nav-profile dropdown"><a
						...
						data-toggle="dropdown" aria-expanded="false">
							<div class="nav-profile-img">
								<img src="upload/${sessionScope.photo }" >
								<span class="availability-status online"></span>
							</div>
							<div class="nav-profile-text">
								<p class="mb-1 text-black"> <s:message code="global.admin.hello"/> ${sessionScope.usernames }
</p>
							</div>
					</a>
						<div class="dropdown-menu navbar-dropdown"
							aria-labelledby="profileDropdown">
							<a class="dropdown-item" href="home/edit-information.htm"> <i
	...
	<div class="container-fluid page-body-wrapper">
		...
		<jsp:include page="client/nav-bar.jsp"></jsp:include>
		<!-- partial -->
