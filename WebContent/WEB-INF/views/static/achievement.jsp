...
<head>
<meta charset="UTF-8">
<title>Manage Reward-Discipline</title>
</head>
<body>
<div class="card">
                  <div class="card-body">
                  <form id="command" class="ml-auto d-flex pt-2 pt-md-0 align-items-stretch w-50 justify-content-end" action="admin/search-record.htm" method="get">
                    ...
                    <h4 class="card-title">Khen thưởng - Kỷ luật</h4>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                       <c:forEach var="u" items="${records}">
									<tr>
										<td>${u.staff.name}</td>
										<td><c:if test="${u.type}">Achievement</c:if> <c:if
													test="${ not u.type}">Discipline</c:if></td>
										<td>${u.reason}</td>
										<td>${u.date}</td>
											<td><a onclick="chayNgayDi('${u.id}','${u.staff.name}')" data-title="Delete" data-toggle="modal" data-target="#delete">
												<button type="button"
													class="btn btn-gradient-primary btn-rounded btn-icon">
													<i class="mdi mdi-delete"></i>
												</button>
										</a>
											<a onclick="chayNgayDi1('${u.id}','${u.staff.name}')" data-title="Delete" data-toggle="modal" data-target="#edit">
												<button type="button"
													class="btn btn-gradient-primary btn-rounded btn-icon">
				  ...
				  <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div ><span class="glyphicon glyphicon-warning-sign"></span>
                                                Bạn có chắc muốn xóa thành tích <span id="nd"></span> ?</div>
                                        </div>
                            ...
                            <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div ><span class="glyphicon glyphicon-warning-sign"></span>
                                                Bạn có chắc muốn sửa thành tích <span id="nd1"></span> ?</div>
                                        </div>
                                        <div class="modal-footer ">
                    ...
                    <br>
                     <tag:paginate max="5" offset="${offset}" count="${count}" uri="admin/achievement.htm" next="Previous" previous="Next"/>
                       <a href="admin/add-achievement.htm"><button type="button" class="btn btn-gradient-success btn-rounded btn-fw">Thêm Mới</button></a>
                  </div>
                </div>
                        <script>
    ...
    function chayNgayDi(id, name) {
      ...
      document.getElementById("idDelelte").href = hre.value + '/admin/delete-achievement.htm?id=' + id;
    }
    ...
    function chayNgayDi1(id, name) {
      ...
      document.getElementById("idEdit").href = hre.value + '/admin/edit-achievement.htm?id=' + id;
    }
