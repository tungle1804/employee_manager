...
<link href="<c:url value="/resources/theme1/css/tabs.scss" />"
...
<link
	...
	rel="stylesheet">
	 <link href="<c:url value="/resources/theme1/css/bootstrapalerts.scss" />"
	 
	rel="stylesheet" type="text/scss">
	
<%-- 	<link href="<c:url value="/resources/theme1/css/style1.css" />"
...
<body >
	...
	<div class="container-scroller">
		...
		<nav
			...
			<div
				...
				<a class="navbar-brand brand-logo" href="admin/static.htm"><img
					src="  resources/theme1/images/logo.svg" /></a> <a
					class="navbar-brand brand-logo-mini" href="admin/static.htm"><img
					src="<c:url value="/resources/theme1/images/logo-mini.svg" />" /></a>
			</div>
					...
					<li class="nav-item nav-profile dropdown"><a
						...
						data-toggle="dropdown" aria-expanded="false">
							...
							<div class="nav-profile-text">
								<p class="mb-1 text-black"> <s:message code="global.admin.hello"/> ${sessionScope.usernames }</p>
							</div>
					</a>
						<div class="dropdown-menu navbar-dropdown"
							aria-labelledby="profileDropdown">
							<a class="dropdown-item" href="admin/edit-information.htm"> <i
								class="mdi mdi-cached mr-2 text-success"></i> Profile
							</a>
							<a class="dropdown-item" href="admin/changepassword.htm"> <i
								class="mdi mdi-box-shadow fa-check-square mr-2 text-success"></i> Change Password
							</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="home/login.htm"> <i
	...
	<div class="container-fluid page-body-wrapper">
		...
		<jsp:include page="static/nav-bar.jsp"></jsp:include>
		<!-- partial -->
